...
public:
    ...
    QVector<int> &Decode_Continuous(const QByteArray& soft_bits_in);//0-->-1 128-->0 255-->1
    QVector<int> &Decode_Continuous_hard(const QByteArray& soft_bits_in);//0-->-1 128-->0 255-->1
